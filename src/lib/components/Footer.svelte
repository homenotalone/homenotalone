...
<NotEditable {editable}>
  <div class="">
    <div class="max-w-screen-md mx-auto px-6 py-12 flex space-x-8 text-sm">
      ...
      <div>Running on <a class="underline font-medium" href="https://github.com/homenotalone/homenotalone">HNA-1</a> the "Home, Not Alone Network" network. Page viewed {count || '…'} times.</div>
    </div>
  </div>
</NotEditable>
